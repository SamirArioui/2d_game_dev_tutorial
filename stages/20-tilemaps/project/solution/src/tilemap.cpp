// ============================================================================
// Tilemap implementation — pure parsing + queries, no SFML.   (REFERENCE SOLUTION)
// ============================================================================
// This is the complete reference implementation of the four Tilemap methods.
// The starter you fill in is one level up at ../../src/tilemap.cpp (everything
