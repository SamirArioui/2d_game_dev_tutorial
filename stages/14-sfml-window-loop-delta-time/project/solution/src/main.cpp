// ============================================================================
// Stage 14 mini-project — a bouncing ball under a fixed-timestep accumulator.  (REFERENCE SOLUTION)
//
// This is the complete reference. The starter you implement is two levels up at
// ../../src/main.cpp (with the sim logic in ../../include/sim.hpp). Build this
// self-contained copy from the solution/ folder — see CMakeLists.txt here.
//
