...
//                                                          (REFERENCE SOLUTION)
// ============================================================================
// This is the complete reference implementation. The starter you fill in is two levels up at
// ../../src/main.cpp. Build this standalone (it has its own CMakeLists.txt) to compare:
//   cmake -S project/solution -B build && cmake --build build && ./build/swap_and_list
//
