// ============================================================================
// Stage 07 mini-project — a tiny turn-based battle       (REFERENCE SOLUTION)
// ============================================================================
// This is the complete reference implementation (all four translation units in this folder).
// The starter you fill in is two levels up in ../../src/. Build this standalone (it has its own
// CMakeLists.txt) to compare:
//   cmake -S project/solution -B build && cmake --build build && ./build/battle
//
