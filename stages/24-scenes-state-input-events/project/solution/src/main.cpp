...
// wired together with an event bus.                        (REFERENCE SOLUTION)
//
// Complete reference. The starter you implement is two levels up (../../src/game_state.cpp,
// ../../src/scene_stack.cpp, ../../include/input/action.hpp, ../../include/events/event_bus.hpp).
// Build this standalone (it has its own CMakeLists.txt):
//   cmake -S project/solution -B build && cmake --build build && ./build/scenes_demo
//
