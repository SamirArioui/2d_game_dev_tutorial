// ============================================================================
// Stage 16 mini-project — mixed balls & rectangles bouncing inside a box.  (REFERENCE SOLUTION)
//
// This is the complete reference. The starter you implement is two levels up at
// ../../src/main.cpp, with the collision predicates in ../../include/collision.hpp.
// Build this self-contained copy from the solution/ folder — see CMakeLists.txt.
//
