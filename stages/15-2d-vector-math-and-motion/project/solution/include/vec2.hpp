...
// ===========================================================================
// gmath — the course's small game-math library (self-contained copy).  (REFERENCE SOLUTION)
//
// This is the fully-implemented reference. The STARTER you fill in is two levels
// up at ../../include/vec2.hpp, where the vector free-function bodies are stubs.
//
