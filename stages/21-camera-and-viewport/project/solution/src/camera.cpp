// ============================================================================
// camera implementation — pure arithmetic, no SFML.   (REFERENCE SOLUTION)
// ============================================================================
// This is the complete reference implementation of the camera maths. The
// starter you fill in is one level up at ../../src/camera.cpp (everything else
// in this folder is identical to the starter). Build this folder standalone to
// see all tests pass:
